...
pub use kvm_bindings::KVM_API_VERSION as API_VERSION;
...
/// structures to be consumed by any VMM's implementation
///
...
impl CpuId {
    ...
    pub fn from_entries(entries: &[CpuIdEntry2]) -> CpuId {
        let mut kvm_cpuid = vec_with_array_field::<CpuId2, CpuIdEntry2>(entries.len());
